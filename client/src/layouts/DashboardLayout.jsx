...
// Refined navigation items with modern semantic outlined icons
const navItems = [
  {
    label: "Overview",
    icon: (
        ...
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between gap-3 border-b border-[#E4E7EF] bg-[#F7F8FC]/90 px-4 sm:px-8 backdrop-blur-md">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-xs text-[#56627A]">
              ...
              <span className="font-semibold text-[#0B1020]">Overview</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="hidden sm:flex items-center gap-2.5">
              <span className="grid h-8 w-8 place-items-center rounded-lg bg-[#EEF0FF] text-xs font-bold text-[#5146E5]">
                {user?.initials ?? "AK"}
              </span>
